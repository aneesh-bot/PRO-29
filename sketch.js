...
function setup() {
 ...
 ground = new Ground();
  ...
  box2 = new Box(730, 200, 50, 50);
  box3 = new Box(670, 200, 50, 50);
  box4 = new Box(700, 100, 50, 50);

  box5 = new Box(500, 325, 50, 50);
  box6 = new Box(530, 325, 50, 50);
  box7 = new Box(470, 325, 50, 50);
  box8 = new Box(500, 225, 50, 50);

  box9  = new Box( 900, 0, 50, 50);
  box10 = new Box( 930, 0, 50, 50);
  box11 = new Box( 870, 0, 50, 50);
  box12 = new Box(900,-100,50, 50);

  box13 = new Box(900,325, 50, 50);
  box14 = new Box(930,325, 50, 50);
  box15 = new Box(870,325, 50, 50);
  box16 = new Box(900,225, 50, 50);

  box17 = new Box( 500, 0, 50, 50);
  box18 = new Box( 530, 0, 50, 50);
  box19 = new Box( 470, 0, 50, 50);
